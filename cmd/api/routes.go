...
func (app *Config) NewRouter() *echo.Echo {
	...
	e.POST("/v1/sign-out", app.baseHandler.SignOut, middleware.AuthTokenMiddleware("customer", "staff"))
	e.POST("/v1/token/validate", app.baseHandler.ValidateToken, middleware.AuthTokenMiddleware("customer", "staff"))
